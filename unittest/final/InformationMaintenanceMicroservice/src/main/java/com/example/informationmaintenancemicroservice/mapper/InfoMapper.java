...
public interface InfoMapper {
    ...
    @Select("select * from comment where fundID = #{fundID}")
    List<Comment> getComment(@Param("fundID")String fundID);

    @Insert("insert into comment values(#{fundID},#{timeStamp},#{comment})")
    void insertComment(@Param("fundID")String fundID,@Param("comment")String Comment,@Param("timeStamp")String timeStamp);
}
